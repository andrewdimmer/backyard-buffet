import { PlantKeysCertian, PlantInfo } from "../@Types/types";

export const getPlantInfo = (key: PlantKeysCertian): PlantInfo => {
  if (key.indexOf("Dandelion") >= 0) {
    return {
      ...
      recipes: [
        ...
        },
        {
          ...
          link: "http://www.davidlebovitz.com/2011/03/dandelion-pesto-recipe/",
        },
        {
    ...
    return {
      ...
      sideEffects: ["Burns from touching the sap (especially from the roots)"],
    };
  } else {
    return {
